...
try {
    ...
    Invoke-RootSQL -Sql 'DROP TABLE IF EXISTS outbox_events; DROP TABLE IF EXISTS wallet_ledger; DROP TABLE IF EXISTS wallet_accounts; DROP TABLE IF EXISTS order_items; DROP TABLE IF EXISTS cart_items; DROP TABLE IF EXISTS orders; DROP TABLE IF EXISTS carts; DROP TABLE IF EXISTS schema_migrations; DROP TABLE IF EXISTS catalog_db.inventory_reservations; DROP TABLE IF EXISTS catalog_db.schema_migrations;' | Out-Null
