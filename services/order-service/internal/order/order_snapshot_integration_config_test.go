...
func TestOrderSnapshotIntegrationConfig(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "missing isolation label skips", env: map[string]string{
		...
		{name: "missing DSN is rejected", env: map[string]string{
			"AI_SHOPPING_INTEGRATION":          "1",
			"AI_SHOPPING_INTEGRATION_ISOLATED": "m21ordersnapshot",
			"AI_SHOPPING_INTEGRATION_RUN_ID":   "ac02029b-8ff5-4f2d-8910-cb258bd78b3d",
		}, wantErr: true},
		{name: "malformed DSN is rejected", env: map[string]string{
			"AI_SHOPPING_INTEGRATION":          "1",
			"AI_SHOPPING_INTEGRATION_ISOLATED": "m21ordersnapshot",
			"AI_SHOPPING_INTEGRATION_RUN_ID":   "ac02029b-8ff5-4f2d-8910-cb258bd78b3d",
			"AI_SHOPPING_MYSQL_DSN":            "not a mysql dsn",
		}, wantErr: true},
		...
		{name: "non loopback host is rejected", env: map[string]string{
			"AI_SHOPPING_INTEGRATION":          "1",
			"AI_SHOPPING_INTEGRATION_ISOLATED": "m21ordersnapshot",
			"AI_SHOPPING_INTEGRATION_RUN_ID":   "ac02029b-8ff5-4f2d-8910-cb258bd78b3d",
			"AI_SHOPPING_MYSQL_DSN":            "app:secret@tcp(mysql.example.test:3310)/trade_db",
		}, wantErr: true},
		{name: "default MySQL port is rejected", env: map[string]string{
			"AI_SHOPPING_INTEGRATION":          "1",
			"AI_SHOPPING_INTEGRATION_ISOLATED": "m21ordersnapshot",
			"AI_SHOPPING_INTEGRATION_RUN_ID":   "ac02029b-8ff5-4f2d-8910-cb258bd78b3d",
			"AI_SHOPPING_MYSQL_DSN":            "app:secret@tcp(127.0.0.1:3306)/trade_db",
		}, wantErr: true},
		...
		{name: "localhost trade database runs", env: map[string]string{
			"AI_SHOPPING_INTEGRATION":          "1",
			"AI_SHOPPING_INTEGRATION_ISOLATED": "m21ordersnapshot",
			"AI_SHOPPING_INTEGRATION_RUN_ID":   "ac02029b-8ff5-4f2d-8910-cb258bd78b3d",
			"AI_SHOPPING_MYSQL_DSN":            "app:secret@tcp(localhost:3310)/trade_db",
		}, wantRun: true, wantRunID: "ac02029b-8ff5-4f2d-8910-cb258bd78b3d"},
		{name: "IPv6 loopback trade database runs", env: map[string]string{
			"AI_SHOPPING_INTEGRATION":          "1",
			"AI_SHOPPING_INTEGRATION_ISOLATED": "m21ordersnapshot",
			"AI_SHOPPING_INTEGRATION_RUN_ID":   "ac02029b-8ff5-4f2d-8910-cb258bd78b3d",
			"AI_SHOPPING_MYSQL_DSN":            "app:secret@tcp([::1]:3310)/trade_db",
		}, wantRun: true, wantRunID: "ac02029b-8ff5-4f2d-8910-cb258bd78b3d"},
	}
